...
export const translations = {
  en: {
    ...
    vitalsNotProvided: 'Vital signs not provided in the case',
    ...
    nfcContinue: 'Complete assessment',
  ...
  ru: {
    ...
    vitalsNotProvided: 'Витальные показатели: в кейсе не указаны',
    ...
    nfcContinue: 'Завершить опросник',
    ...
    nfcQ2: 'Мне нравится брать на себя ответственность в ситуациях, которые требуют серьёзных размышлений.',
    nfcQ3: 'Размышления не приносят мне удовольствия.',
    nfcQ4: 'Я бы предпочёл(предпочла) заниматься тем, что требует мало размышлений, а не тем, что бросает вызов моим умственным способностям.',
    nfcQ5: 'Мне действительно нравится задача, которая требует придумывать новые решения проблем.',
    nfcQ6: 'Я предпочитаю думать о небольших повседневных проектах, а не о долгосрочных.',
    nfcQ7: 'Я бы предпочёл(предпочла) задачу, которая интеллектуальна, сложна и важна, задаче, которая в какой-то мере важна, но не требует больших размышлений.',
    nfcQ8: 'Я нахожу удовлетворение в том, чтобы долго и усердно заниматься.',
    nfcQ9: 'Я думаю ровно настолько, насколько от меня этого ожидают.',
    nfcQ11: 'Я предпочитаю думать о небольших повседневных проектах, а не о долгосрочных.',
    nfcQ12: 'Мне нравится мысль о том, чтобы опираться на собственное мышление и быть на высоте.',
    nfcQ14: 'Изучение новых способов мышления не вызывает у меня особого интереса.',
    nfcQ15: 'Я предпочёл(предпочла) бы, чтобы моя жизнь была наполнена задачами-головоломками, которые мне нужно решать.',
    nfcQ16: 'Идея мыслить абстрактно кажется мне привлекательной.',
    nfcQ18: 'После завершения задачи, потребовавшей больших умственных усилий, я чувствую только облегчение, но не удовлетворение.',
