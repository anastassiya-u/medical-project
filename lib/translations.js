...
export const translations = {
  ...
  ru: {
    ...
    // NFC Questions (Improved professional Russian translations)
    ...
    nfcQ3: 'Размышление — не то, что доставляет мне удовольствие.',
    nfcQ4: 'Я скорее выберу задачу, которая требует минимальных усилий, чем ту, которая бросает вызов моему мышлению.',
    ...
    nfcQ8: 'Я получаю удовлетворение от длительных и напряжённых размышлений.',
    nfcQ9: 'Я думаю настолько глубоко, насколько это необходимо, и не больше.',
    nfcQ10: 'Я предпочитаю заниматься небольшими повседневными задачами, а не долгосрочными проектами.',
    nfcQ11: 'Мне нравятся задачи, которые после освоения не требуют серьёзных умственных усилий.',
    nfcQ12: 'Мне нравится идея достигать успеха благодаря собственным размышлениям.',
    nfcQ13: 'Мне действительно нравятся задачи, в которых нужно искать новые решения проблем.',
    ...
    nfcQ17: 'Я скорее выберу интеллектуально сложную и значимую задачу, чем менее важную, но простую.',
    nfcQ18: 'После выполнения сложной умственной задачи я чаще чувствую облегчение, чем удовлетворение.',
